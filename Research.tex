...
\item Users must be able to enter the following registration information: Full name, Email address, Password and Language.
\end{itemize}
...
\item Users could be able to enter a predefined questionnaire.
\end{itemize}
