...
\item Users must be able to enter registration information.
\item The registration information must contain ...TODO{kinds of registration information}
...
\reqr{Should have}
\begin{itemize}
\item Users should be able to enter basic user information.
\item The basic user information should contain ...TODO{kinds of basic user information}
...
\reqr{Could have}
\begin{itemize}
\item Users could be able to enter extended user information.
\item The extended user information could contain ...TODO{kinds of extended user information}
\item A questionnaire could added to the user information.
\item This questionnaire could contain ....TODO{kinds of questions for the questionnaire}
...
\reqr{Must have}
\begin{itemize}
\item The algorithm must be able to return possible practical partners to the user.
\item The algorithm must be able to return more then one possible practical partner.
\item The algorithm must be able to return a partner given a list of unwanted (allready rejected) partners.
\item The algorithm must be able to handle the addition and deleting of users.
\end{itemize}
