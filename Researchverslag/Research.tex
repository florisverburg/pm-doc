...
This actor consist of two or more MOOC participants who accepted each other to their \TODO{group.schetsen}
...
\section{Basic system requirements}
...
\item The administrator must be able to open and close the participant registration for a MOOC.
