...
The whole original assignment can be found in Appendix A. In this section we just provide a short summary of the assignment. 
\\\\
...
\subsection{Profile}
As you can see in Figure~\ref{mockup_profile}, 
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{images/mockup_profile}
